...
Class APNS {
	...
	static function Connection($options = []) {
	...
	static function SendMessage(APNSMessage $message) {
		$connection = self::Connection();
		$connection->send($message);
	}
	
	function sendClose(APNSMessage $message) {
		$this->send($message);
		$this->close();
	}
	
	function send(APNSMessage $message) {
		try {
